...
//                System.out.print(array[i] + " ");
    ...
    public static int[] printElementsWhereModulo(int[] array, int m, int l) {
        int count = 0;
        for (int i = 0; i < array.length; i++) {
            if (array[i] % m == l) {
                count++;
    ...
    public static int[] printAllElementsBeforeZero(int[] array) {
        int i = 0;
        do {
//            System.out.print(array[i] + " ");
            i++;
    ...
    public static int getProdOfArrayElementsBiggerThan(int[] arrayToChange, int changer) {
        int prod = 1;
        int counter = 0;
...
//    модулем Р1 и указать, какое из произведений по модулю больше.
    ...
    public static boolean printBiggestAbsProductionOfElements(int[] array) {
        int p1 = 1;
        int p2 = 1;
        for (int i = 0; i < array.length; i++) {
