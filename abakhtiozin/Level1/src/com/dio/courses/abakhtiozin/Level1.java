...
//        }
    ...
    public static void changeAllElemOfArrayBiggerThen(int[] arrayToChange, int changer) {
        int counter = 0;
    ...
    public static void getCountOfZeroPlusAndNegativeNum(int[] array) {
        int positive = 0;
        int negative = 0;
        int zero = 0;
    ...
    public static void changeMaxAndMinNumOfArray(int[] array) {
        int max = array[0];
        int min = array[0];
        int numberOfMax = 0;
        int numberOfMin = 0;
    ...
    public static void printElementsWherePositionBiggerThanValue(int[] array) {
        for (int i = 0; i < array.length; i++) {
            if (array[i] <= i) {
